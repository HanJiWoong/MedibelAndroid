...
import com.exs.medivelskinmeasure.UI.AnalysisResult.BeautyShopAnalysisResultActivity
...
class BeautyShopCustomerInfoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_beauty_shop_customer_info)
    ...
    private fun initUI() {
        mTitleBar = findViewById(R.id.ViewBeautyShopCustomerInfoTitleBar)
        mTitleBar.mStrTitle = getString(R.string.str_ko_customer_info_title)
        mTitleBar.setCloseMode(true)

        mViewCustomerNumber = findViewById(R.id.ViewBeautyShopCustomerInfoNumber)
        ...
        mViewCustomerBirthYear = findViewById(R.id.ViewBeautyShopCustomerInfoBirthYear)
        ...
        mBtnAnalysisResult = findViewById(R.id.BtnBeautyShopCustomerInfoAnalysisResult)
    }
    ...
    private fun setCommonListener() {
        ...
        mBtnAnalysisResult.setOnClickListener {
            val intent = Intent(this, BeautyShopAnalysisResultActivity::class.java)
            startActivity(intent)
            overridePendingTransition(R.anim.anim_fade_in, R.anim.anim_do_not_move)
