...
class MainBeautyShopActivity : AppCompatActivity() {
    ...
    fun initUI() {
        ...
        mBtnMeasureSkin = findViewById(R.id.BtnMainBeautyShopMeasureSkin)
    ...
    fun setCommonListener() {
        mBtnMeasureSkin.setOnClickListener {
            if (isConnected) {
                MqttClient.publishUserInfoSetting(this@MainBeautyShopActivity)
                mBtnMeasureSkin.isEnabled = false
            } else {
                val intent =
                    Intent(this@MainBeautyShopActivity, ConnectStateActivity::class.java)
        ...
        MqttClient.listener = object : MqttClient.MQTTClientInterface {
            ...
            override fun responseUserInfo(result: Boolean, msg: String?) {
                if(result) {
                    ...
                    mBtnMeasureSkin.isEnabled = true
                    Toast.makeText(this@MainBeautyShopActivity, msg, Toast.LENGTH_SHORT).show()
                }
            }
