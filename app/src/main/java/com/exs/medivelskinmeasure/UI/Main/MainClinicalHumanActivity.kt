...
class MainClinicalHumanActivity : AppCompatActivity() {
    ...
    fun initUI() {
        ...
        mBtnMeasureSkin = findViewById(R.id.BtnMainClinicalHumanMeasureSkin)
    ...
    fun setCommonListener() {
        mBtnMeasureSkin.setOnClickListener {
            if (isConnected) {
                MqttClient.publishUserInfoSetting(this@MainClinicalHumanActivity)
                mBtnMeasureSkin.isEnabled = false
            } else {
                val intent =
                    Intent(this@MainClinicalHumanActivity, ConnectStateActivity::class.java)
        ...
        MqttClient.listener = object : MqttClient.MQTTClientInterface {
            ...
            override fun responseUserInfo(result: Boolean, msg: String?) {
                if(result) {
                    ...
                    mBtnMeasureSkin.isEnabled = true
                    Toast.makeText(this@MainClinicalHumanActivity, msg, Toast.LENGTH_SHORT).show()
                }
            }
